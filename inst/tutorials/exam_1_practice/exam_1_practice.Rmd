...
The following code loads the packages you will need for this exam, and the dataset
you will be using. The dataset is the same you used for your week 3 assignment,
with data on forest trees in Florida. If you click 'Run Code' it will be run
in RStudio, so you can view the environment browser, and access all of RStudio's
features.
